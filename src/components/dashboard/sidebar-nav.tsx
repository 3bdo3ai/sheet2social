  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mt-4 border-t border-[var(--border)] pt-4">
        <LogoutButton className="group flex w-full items-center gap-3 rounded-2xl border border-[var(--border)] bg-[#111f3a] px-3.5 py-3 text-[0.95rem] font-semibold tracking-[0.01em] text-[#b8c8e2] transition-all duration-200 hover:border-[#4f7cb4] hover:bg-[#13274a] hover:text-[#edf6ff]" />
      </div>
    </div>
  );
}
